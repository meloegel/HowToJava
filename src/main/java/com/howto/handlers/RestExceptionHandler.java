package com.howto.handlers;

import com.howto.exceptions.ResourceFoundException;
import com.howto.exceptions.ResourceNotFoundException;
import com.howto.models.ErrorDetail;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleOAuth2AccessDeniedException(OAuth2AccessDeniedException ex) {
        return new ResponseEntity<>(ex, null, HttpStatus.resolve(ex.getHttpErrorCode()));
    }
